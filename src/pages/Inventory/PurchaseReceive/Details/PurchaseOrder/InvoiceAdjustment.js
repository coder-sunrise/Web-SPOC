...
@withFormik({
  ...
  handleSubmit: (values, { props }) => {
    if (props.onConfirm) {
      ...
      const { adjustmentList, setFieldValue } = props
      const { remarks, adjustment } = values

      const newAdjustmentList = adjustmentList
      newAdjustmentList.push({
        adjTitle: remarks,
        adjAmount: adjustment,
      })

      console.log('InvoiceAdjustment', values)

      setFieldValue('adjustmentList', newAdjustmentList)
    }
  },
