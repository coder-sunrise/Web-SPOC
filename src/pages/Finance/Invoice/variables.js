...
export const InvoiceGridColExtensions = [
  ...
  { columnName: 'invoiceTotalAftGST', type: 'currency', currency: true, sortBy: 'TotalAftGST'},
  ...
  { columnName: 'totalOutstanding', type: 'currency', currency: true, sortBy: 'OutstandingBalance' },
]
