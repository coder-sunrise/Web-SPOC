...
// styles
import accordionStyle from './packageDrawdownAccordionStyle'
...
class PackageDrawdownAccordion extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
...
PackageDrawdownAccordion.defaultProps = {
  // active: -1,
  // activedKeys: [],
}

PackageDrawdownAccordion.propTypes = {
...
export default withStyles(styles)(PackageDrawdownAccordion)
