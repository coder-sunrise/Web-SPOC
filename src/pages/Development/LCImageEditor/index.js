...
import AddImage from '@material-ui/icons/AddPhotoAlternate'
...
*/
  ...
  _hideDrawing = () => {
    ...
    // this.setState({
    //   hideButtonEnable: true,
    //   hideEnable: !this.state.hideEnable,
    // })

    // if (this.state.hideEnable) {
    //   this.setState({
    //     canUndo: false,
    //     canRedo: false,
    //     canClear: false,
  ...
  _onBackgroundImageDrop = (accepted /*, rejected*/) => {
    ...
    if (accepted && accepted.length > 0) {
      ...
      var newIndexCount = indexCount + 1
  ...
  _setTemplate = () => {
   ...
   this._sketch.setTemplate(this.state.exampleImage, -100)
    ...
    //   indexCount: newIndexCount,
    //   template: this.state.exampleImage
    // })
  }
        ...
        <GridContainer>
          ...
          >
            ...
            >
              ...
              <Tooltip title='Add More Template'>
                <ToggleButton
                  key={7}
                  onClick={(event) => {
                    this.setState({
