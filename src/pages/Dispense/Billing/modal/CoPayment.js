...
// common components
import { Button, EditableTableGrid, GridContainer, GridItem, Select } from '@/components'
// data table variable
import { CoPaymentColumns, CoPaymentColExtensions, CoPaymentData } from '../variables'
