...
const Detail = ({
  theme, footer, settingAdministrationRoute, clinicSettings, handleSubmit, values, setFieldValue
}) => {
            ...
            <FastField
              ...
              render={(args) => (
                <TextField
                  ...
                  autoFocus
                  {...args}
                  disabled={!!settingAdministrationRoute.entity}
                />
              )}
            />
          </GridItem>
...
export default compose(
  withFormikExtend({
    ...
    mapPropsToValues: ({ settingAdministrationRoute, clinicSettings }) => {
      let settings = settingAdministrationRoute.entity || settingAdministrationRoute.default
    ...
    handleSubmit: (values, { props, resetForm }) => {
      ...
      dispatch({
        type: 'settingAdministrationRoute/upsert',
        payload: {
          ...restValues,
    ...
    displayName: 'AdministrationRouteDetail',
  }),
)(Detail)
