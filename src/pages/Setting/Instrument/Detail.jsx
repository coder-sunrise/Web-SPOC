...
let _withFormikExtend = withFormikExtend({
  mapPropsToValues: ({ settingInstrument }) =>
    settingInstrument.entity || settingInstrument.default,
...
let Detail = props => {
  let { footer, settingInstrument, handleSubmit } = props
  let theme = useTheme()
  return (
    <React.Fragment>
            ...
            <FastField
              ...
              render={args => (
                <TextField
                  ...
                  autoFocus
                  {...args}
                  disabled={!!settingInstrument.entity}
                />
              )}
            />
          </GridItem>
