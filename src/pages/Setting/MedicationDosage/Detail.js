...
const Detail = ({
  theme, footer, settingMedicationDosage, clinicSettings, handleSubmit, values, setFieldValue
}) => {
        ...
        <GridContainer>
          ...
          <GridItem md={8}>
            <FastField
              name='displayValue'
              render={(args) => {
                return <TextField label={`Display Value${isUseSecondLanguage ? ` (${primaryPrintoutLanguage})` : ''}`} {...args} maxLength={200}
                  onChange={(e) => {
