...
let _withFormikExtend = withFormikExtend({
  mapPropsToValues: ({ settingGradingChart }) =>
    settingGradingChart.entity || settingGradingChart.default,
  ...
  handleSubmit: (values, { props: { toggleModal, dispatch }, resetForm }) => {
    ...
    dispatch({
      type: 'settingGradingChart/upsert',
      payload: {
        ...restValues,
...
let Detail = props => {
  let { footer, settingGradingChart, handleSubmit } = props
  let theme = useTheme()
  return (
    <React.Fragment>
            ...
            <FastField
              ...
              render={args => (
                <TextField
                  ...
                  autoFocus
                  {...args}
                  disabled={!!settingGradingChart.entity}
                />
              )}
            />
          </GridItem>
