...
export const CANNED_TEXT_TYPE = {
  ...
  RADIOLOGYREMARK: 8,
  RADIOLOGYINSTRUCTION: 9,
}

export const CANNED_TEXT_TYPE_BASE_TEXT = [CANNED_TEXT_TYPE.MEDICALCERTIFICATE, CANNED_TEXT_TYPE.RADIOLOGYREMARK, CANNED_TEXT_TYPE.RADIOLOGYINSTRUCTION]
