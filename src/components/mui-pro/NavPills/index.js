...
import navPillsStyle from 'mui-pro-jss/material-dashboard-pro-react/components/navPillsStyle.jsx'
...
class NavPills extends React.Component {
  ...
  handleChange = (event, active) => {
    ...
    if (onChange) onChange(event, active)
  }
