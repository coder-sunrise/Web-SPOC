...
import customDropdownStyle from 'mui-pro-jss/material-dashboard-pro-react/components/customDropdownStyle.jsx'
  ...
  render () {
    ...
    return (
      <div className={innerDropDown ? classes.innerManager : classes.manager}>
        <div
          className={
            buttonText !== undefined ? classes.inlineDiv : classes.target
          }
        >
          <Button
